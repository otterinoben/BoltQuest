  ...
  useEffect(() => {
    ...
    try {
      ...
      if (userProfile?.preferences) {
        setSelectedCategories(userProfile.preferences.defaultCategories || []);
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-gray-50 to-white" />
                ...
                <div className="relative max-w-6xl mx-auto px-6 py-8">
                  ...
                  {/* Quick Start Card - Clean White */}
                  <div className="relative">
                    <div className="bg-white border-2 border-gray-200 rounded-3xl shadow-sm p-6">
                      <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold text-black mb-2">Quick Start</h2>
                        <p className="text-gray-600">
                          Jump right in with smart defaults
                        </p>
                      </div>
              ...
              <div className="mb-6">
                    <h3 className="text-lg font-bold text-black mb-3 text-center">
                      Choose Your Focus {selectedCategories.length > 0 && `(${selectedCategories.length}/3)`}
                    </h3>
              ...
              {/* Game Mode Selection */}
              <div className="mb-6">
                <h3 className="text-lg font-bold text-black mb-3 text-center">Game Mode</h3>
              ...
              <div className="mb-6">
                  <h3 className="text-lg font-bold text-black mb-3 text-center">Select Difficulty</h3>
                ...
                {/* Timer Options - Clean Style */}
                <div className="mb-6">
                  <h3 className="text-lg font-bold text-black mb-3 text-center">Quick Timer Options</h3>
                  <div className="flex justify-center space-x-3">
                          ...
                          <div className="relative w-16 h-16">
                            <svg className="w-16 h-16 transform -rotate-90" viewBox="0 0 32 32">
                              ...
                              <circle
                                ...
                                strokeDashoffset={`${2 * Math.PI * 14 * (1 - (seconds / 60))}`}
                              />
                            </svg>
                            {/* Center icon */}
                ...
                <Button 
                  size="lg" 
                    className="px-6 py-3 text-base font-medium bg-black text-white border-2 border-black transition-all duration-200 min-h-[48px] disabled:opacity-50 disabled:cursor-not-allowed group"
                  onClick={startGame}
                    disabled={selectedCategories.length === 0}
                >
                      <div className="flex items-center">
                        <div className="p-2 rounded-lg bg-gray-800 group-hover:bg-green-500 transition-colors mr-2">
                          <PlayIcon className="h-5 w-5 text-white" />
                        </div>
                        <span className="group-hover:text-green-400 transition-colors">Start Playing</span>
                      </div>
                </Button>
                <Button 
                  size="lg" 
                  className="px-6 py-3 text-base font-medium bg-white text-black border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 min-h-[48px]"
                  onClick={startRandomGame}
                >
                    <Shuffle className="mr-2 h-5 w-5 text-gray-600" />
                    Random
                </Button>
                </div>
              </div>
