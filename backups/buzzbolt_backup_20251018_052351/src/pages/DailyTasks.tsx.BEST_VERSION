...
import { getUserLevelProgress, getLevelData } from '@/lib/dailyTaskLeveling';
              ...
              <div className="space-y-4">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">
                    {getLevelData(levelProgress.currentLevel)?.name}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-gray-500 text-center">
                    {Math.round(levelProgress.progressToNextLevel)}% complete
                  </div>
                </div>
              </div>
            </CardContent>
